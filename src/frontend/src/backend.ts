...
export class Backend implements backendInterface {
    ...
    async getMenu(): Promise<Array<Product>> {
    ...
    async getOrders(): Promise<Array<BakeryOrder>> {
        if (this.processError) {
            try {
    ...
    async placeOrder(arg0: string, arg1: string, arg2: string, arg3: string, arg4: Array<[bigint, bigint]>): Promise<bigint> {
        if (this.processError) {
            try {
